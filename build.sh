...
buildDebugVersion() {
	...
	if [ -e "Makefile" ]; then
		...
		valgrind --version
		valgrind --leak-check=full --xml=yes --xml-file=/opt/tomcat/.jenkins/jobs/GoMaster/workspace/report/valgrind/valgrindFTest.%p.xml /opt/tomcat/.jenkins/jobs/GoMaster/workspace/build/debug/GoTests/FunctionalTest/FTest || true
		valgrind --leak-check=full --xml=yes --xml-file=/opt/tomcat/.jenkins/jobs/GoMaster/workspace/report/valgrind/valgrindBoardTest.%p.xml /opt/tomcat/.jenkins/jobs/GoMaster/workspace/build/debug/GoTests/UnitTests/BoardTest || true
